...
def most_common_words(selected_user, df):
    ...
    # Remove edited-message notifications
    temp = temp[~temp['message'].str.contains(
    ...
    for message in temp['message']:
        ...
        # Remove invisible Unicode characters from WhatsApp export
